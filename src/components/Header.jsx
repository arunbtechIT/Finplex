...
function Header(){
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="features.html">Contests</a></li>
                                        <li><a href="Pricing.html">Companies</a></li> 
                                       <li><a href="#">blog <i class="ti-angle-down"></i></a>
                                        ...
                                        <li><a href="#">FAQ <i class="ti-angle-down"></i></a>
                                        	 <ul class="submenu">
                                                 <li><a href="elements.html">what is finplex</a></li>
                                                 <li><a href="elements.html">How can i play and earn cash</a></li>
                                                 <li><a href="elements.html">Login</a></li>
                                                 <li><a href="elements.html">signup</a></li> 
                                    </ul></li>
    ...
    <div class="slider_area">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-md-6">
                        <div class="slider_text ">
                            <h3 class="wow fadeInDown" data-wow-duration="1s" data-wow-delay=".1s" >Finplex <br></br>
                                </h3>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">Join in on the world's first trading app with a competetive spirit</p>
        ...
        <div class=" button col-xl-5 col-md-12 col-lg-6">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center  wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s">
                        <h3>Win multiple time <br />
                                of the amount invested</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                        <div class="single_service text-center wow fadeInUp" data-wow-duration=".7s" data-wow-delay=".5s">
                                ...
                                <h3>Withdraw money in bank <br /> 
                                        once the minimum amount is reached</h3>
                            </div>
                </div>
                <div class="col-lg-4 col-md-4">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-6 ">
                    <div class="mobile_screen wow fadeInRight" data-wow-duration=".8s" data-wow-delay=".5s">
                        <img src="img/ilstrator_img/player.jpeg" alt=""/>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="single_service  wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s">
                            <span>01</span>
                            <h3>Sign Up and get ₹50</h3>
                            <p>Invite friends and get another ₹20</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single_service  wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".4s">
                            <span>02</span>
                            <h3>Start a match</h3>
                            <p>Invest in a company and wait to see how its stocks perform.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4  wow fadeInUp" data-wow-duration=".7s" data-wow-delay=".5s">
                        <div class="single_service">
                            ...
                            <p>Create and play your own matches in public or private circle.</p>
                        </div>
                    </div>
                </div>
            </div>
